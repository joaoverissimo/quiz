...
// <editor-fold defaultstate="collapsed" desc="Objetos Associados">
    ...
    /**
     * Obtem a associacao entre epergunta.imagem => jqueryimage.cod
    ...
    /**
     * Obtem a associacao entre epergunta.quiz => equiz.cod
     * @return objEquiz
     */
...
// <editor-fold defaultstate="collapsed" desc="Load And Save">
    ...
    public function loadByCod($valor, $campo = 'cod') {
        $registro = dbEpergunta::Carregar($this->Conexao, $valor, $campo);
    ...
    public function loadLeftByCod($valor, $campo = 'cod') {
        $registro = dbEpergunta::CarregarLeft($this->Conexao, $valor, $campo);
    ...
    public function Save() {
        if (isset($this->cod) && is_numeric($this->cod)) {
            return dbEpergunta::Update($this->Conexao, $this->getcod(),$this->getquiz(),$this->getdescricao(),$this->getimagem(),$this->getordem());
        } else {    
            $this->cod = dbEpergunta::Inserir($this->Conexao, $this->getquiz(),$this->getdescricao(),$this->getimagem(),$this->getordem());
            return $this->cod != 0;
        }      
    }
    
    public function Delete() {
        return dbEpergunta::Deletar($this->Conexao, $this->cod);
    }
...
// <editor-fold defaultstate="collapsed" desc="Stringuize">
    ...
    public function getHtmlTemplateString($html, $prefix = '') {
        ...
        if ($html == "") {
            $this->die = false;
            echo "\nMetodo Permitidos para objEpergunta: [";
    ...
    public function getHtmlTemplateFile($file, $folder = "~/adm/epergunta/templates/") {
        if (!$file) {
...
// </editor-fold>
    ...
    public static function init($valor, $campo = 'cod', $die = true, $Conexao = null) {
        ...
        $obj = new objEpergunta($Conexao, $die);
