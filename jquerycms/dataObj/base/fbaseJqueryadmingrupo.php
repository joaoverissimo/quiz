...
// <editor-fold defaultstate="collapsed" desc="Load And Save">
    ...
    public function loadByCod($valor, $campo = 'cod') {
        $registro = dbJqueryadmingrupo::Carregar($this->Conexao, $valor, $campo);
    ...
    public function loadLeftByCod($valor, $campo = 'cod') {
        $registro = dbJqueryadmingrupo::CarregarLeft($this->Conexao, $valor, $campo);
    ...
    public function Save() {
        if (isset($this->cod) && is_numeric($this->cod)) {
            return dbJqueryadmingrupo::Update($this->Conexao, $this->getcod(),$this->gettitulo());
        } else {    
            $this->cod = dbJqueryadmingrupo::Inserir($this->Conexao, $this->gettitulo());
            return $this->cod != 0;
        }      
    }
    
    public function Delete() {
        return dbJqueryadmingrupo::Deletar($this->Conexao, $this->cod);
    }
...
// <editor-fold defaultstate="collapsed" desc="Stringuize">
    ...
    public function getHtmlTemplateString($html, $prefix = '') {
        ...
        if ($html == "") {
            $this->die = false;
            echo "\nMetodo Permitidos para objJqueryadmingrupo: [";
    ...
    public function getHtmlTemplateFile($file, $folder = "~/adm/jqueryadmingrupo/templates/") {
        if (!$file) {
...
// </editor-fold>
    ...
    public static function init($valor, $campo = 'cod', $die = true, $Conexao = null) {
        ...
        $obj = new objJqueryadmingrupo($Conexao, $die);
