...
// <editor-fold defaultstate="collapsed" desc="Load And Save">
    ...
    public function loadByCod($valor, $campo = 'cod') {
        $registro = dbJqueryseo::Carregar($this->Conexao, $valor, $campo);
    ...
    public function loadLeftByCod($valor, $campo = 'cod') {
        $registro = dbJqueryseo::CarregarLeft($this->Conexao, $valor, $campo);
    ...
    public function Save() {
        if (isset($this->cod) && is_numeric($this->cod)) {
            return dbJqueryseo::Update($this->Conexao, $this->getcod(),$this->gettitulo(),$this->getdescricao());
        } else {    
            $this->cod = dbJqueryseo::Inserir($this->Conexao, $this->gettitulo(),$this->getdescricao());
            return $this->cod != 0;
        }      
    }
    
    public function Delete() {
        return dbJqueryseo::Deletar($this->Conexao, $this->cod);
    }
...
// <editor-fold defaultstate="collapsed" desc="Stringuize">
    ...
    public function getHtmlTemplateString($html, $prefix = '') {
        ...
        if ($html == "") {
            $this->die = false;
            echo "\nMetodo Permitidos para objJqueryseo: [";
    ...
    public function getHtmlTemplateFile($file, $folder = "~/adm/jqueryseo/templates/") {
        if (!$file) {
...
// </editor-fold>
    ...
    public static function init($valor, $campo = 'cod', $die = true, $Conexao = null) {
        ...
        $obj = new objJqueryseo($Conexao, $die);
