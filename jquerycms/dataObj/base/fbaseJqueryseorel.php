 ...
 * @property objJqueryseopalavra $_objJqueryseopalavra
 * 
 */
class fbaseJqueryseorel {
...
// <editor-fold defaultstate="collapsed" desc="Objetos Associados">
    ...
    /**
     * Obtem a associacao entre jqueryseorel.seo => jqueryseo.cod
     * @return objJqueryseo
     */
    ...
    /**
     * Obtem a associacao entre jqueryseorel.palavra => jqueryseopalavra.cod
     * @return objJqueryseopalavra
     */
    public function objPalavra(){
        if (! isset($this->_objPalavra)) { 
            $obj = new objJqueryseopalavra($this->Conexao, false); 
            $obj->loadByCod($this->palavra); 
            $this->_objPalavra = $obj; 
        } 
        
        return $this->_objPalavra; 
    }
...
// <editor-fold defaultstate="collapsed" desc="Load And Save">
    ...
    public function loadByCod($valor, $campo = 'cod') {
        $registro = dbJqueryseorel::Carregar($this->Conexao, $valor, $campo);
    ...
    public function loadLeftByArray($registro) {
        ...
        $obj = new objJqueryseopalavra($this->Conexao, false);
        $obj->loadByArray($registro, 'palavra_');
        $this->_objPalavra = $obj;                
    ...
    public function loadLeftByCod($valor, $campo = 'cod') {
        $registro = dbJqueryseorel::CarregarLeft($this->Conexao, $valor, $campo);
    ...
    public function Save() {
        if (isset($this->cod) && is_numeric($this->cod)) {
            return dbJqueryseorel::Update($this->Conexao, $this->getcod(),$this->getseo(),$this->getpalavra());
        } else {    
            $this->cod = dbJqueryseorel::Inserir($this->Conexao, $this->getseo(),$this->getpalavra());
            return $this->cod != 0;
        }      
    }
    
    public function Delete() {
        return dbJqueryseorel::Deletar($this->Conexao, $this->cod);
    }
...
// <editor-fold defaultstate="collapsed" desc="Stringuize">
    ...
    public function getHtmlTemplateString($html, $prefix = '') {
        ...
        if ($html == "") {
            $this->die = false;
            echo "\nMetodo Permitidos para objJqueryseorel: [";
    ...
    public function getHtmlTemplateFile($file, $folder = "~/adm/jqueryseorel/templates/") {
        if (!$file) {
...
// </editor-fold>
    ...
    public static function init($valor, $campo = 'cod', $die = true, $Conexao = null) {
        ...
        $obj = new objJqueryseorel($Conexao, $die);
