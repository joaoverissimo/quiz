...
$where = '';
if ($filtraList) {
    //$where = new dataFilter(dbJqueryseotabela::_cod, 0, dataFilter::op_different);
    $where = new dataFilter(dbJqueryseotabela::_tabela, $filtraList, dataFilter::op_likeMatches);
}

$orderBy = new dataOrder('jqueryseotabela.cod', 'desc');

$paginaAtual = 0;
if (isset($_REQUEST['page']))
    $paginaAtual = $_REQUEST['page'];

$pager = new dataPager($paginaAtual, 15, $Conexao, 'jqueryseotabela', $where);

$dados = dbJqueryseotabela::ObjsListLeft($Conexao, $where, $orderBy, $pager->getLimit());
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_jqueryseotabela'); ?> <small>Listar</small></h3>
                </div>
                    ...
                    <table class="table table-hover table-striped" id="tablelista">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('jqueryseotabela.cod');?></th> 
                                <th><?php echo __('jqueryseotabela.tabela');?></th> 
                                <th><?php echo __('jqueryseotabela.titulo');?></th> 
                                <th><?php echo __('jqueryseotabela.ordem');?></th> 
                            ...
                            <tr>
                                ...
                                <td><?php echo $registro->getTabela(); ?></td>
