...
if (count($_POST) > 0) {
    if (issetArray($_POST['multi'])) {
        foreach ($_POST['multi'] as $cod) {
            try {
                $registro = new objJqueryseotabela($Conexao, true);
...
<html>
    <head>
        <title><?php echo __('table_jqueryseotabela');?> - Deletar</title>
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_jqueryseotabela');?> <small>Deletar Selecionados</small></h3>
                </div>
