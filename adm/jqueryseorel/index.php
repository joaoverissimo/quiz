...
$where = '';
if ($filtraList) {
    //$where = new dataFilter(dbJqueryseorel::_cod, 0, dataFilter::op_different);
    $where = new dataFilter(dbJqueryseorel::_cod, $filtraList, dataFilter::op_likeMatches);
}

$orderBy = new dataOrder('jqueryseorel.cod', 'desc');

$paginaAtual = 0;
if (isset($_REQUEST['page']))
    $paginaAtual = $_REQUEST['page'];

$pager = new dataPager($paginaAtual, 15, $Conexao, 'jqueryseorel', $where);

$dados = dbJqueryseorel::ObjsListLeft($Conexao, $where, $orderBy, $pager->getLimit());
...
<html>
    <head>
        <title><?php echo __('table_jqueryseorel'); ?> - Listar</title>
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_jqueryseorel'); ?> <small>Listar</small></h3>
                </div>
                    ...
                    <table class="table table-hover table-striped" id="tablelista">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('jqueryseorel.cod');?></th> 
                                <th><?php echo __('jqueryseorel.palavra');?></th> 
                            ...
                            <tr>
                                ...
                                <td><?php echo $registro->objPalavra()->getPalavra(); ?></td>
