...
$where = '';
if ($filtraList) {
    //$where = new dataFilter(dbEalternativaresultado::_cod, 0, dataFilter::op_different);
    $where = new dataFilter(dbEalternativaresultado::_cod, $filtraList, dataFilter::op_likeMatches);
}

$orderBy = new dataOrder('ealternativaresultado.cod', 'desc');

$paginaAtual = 0;
if (isset($_REQUEST['page']))
    $paginaAtual = $_REQUEST['page'];

$pager = new dataPager($paginaAtual, 15, $Conexao, 'ealternativaresultado', $where);

$dados = dbEalternativaresultado::ObjsListLeft($Conexao, $where, $orderBy, $pager->getLimit());
...
<html>
    <head>
        <title><?php echo __('table_ealternativaresultado'); ?> - Listar</title>
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_ealternativaresultado'); ?> <small>Listar</small></h3>
                </div>
                    ...
                    <table class="table table-hover table-striped" id="tablelista">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('ealternativaresultado.cod');?></th> 
                                <th><?php echo __('ealternativaresultado.quiz');?></th> 
                                <th><?php echo __('ealternativaresultado.pergunta');?></th> 
                                <th><?php echo __('ealternativaresultado.alternativa');?></th> 
                                <th><?php echo __('ealternativaresultado.resultado');?></th> 
                            ...
                            <tr>
                                ...
                                <td><?php echo $registro->objPergunta()->getDescricao(); ?></td>
                                <td><?php echo $registro->objAlternativa()->getDescricao(); ?></td>
                                <td><?php echo $registro->objResultado()->getDescricao(); ?></td>
