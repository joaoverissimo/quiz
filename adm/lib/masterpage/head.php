...
<script>
    $(document).ready(function () {
        $("a[href='/adm/ealternativa/index.php']").closest("li").hide();
        $("a[href='/adm/ealternativaresultado/index.php']").closest("li").hide();
        $("a[href='/adm/epergunta/index.php']").closest("li").hide();
        $("a[href='/adm/eresultado/index.php']").closest("li").hide();
    });
</script>