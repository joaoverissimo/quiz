...
$where = '';
if ($filtraList) {
    //$where = new dataFilter(dbJqueryadminuser::_cod, 0, dataFilter::op_different);
    $where = new dataFilter(dbJqueryadminuser::_nome, $filtraList, dataFilter::op_likeMatches);
}

$orderBy = new dataOrder('jqueryadminuser.cod', 'desc');
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_jqueryadminuser'); ?> <small>Listar</small></h3>
                </div>
                    ...
                    <table class="table table-hover table-striped" id="tablelista">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('jqueryadminuser.cod');?></th> 
                                <th><?php echo __('jqueryadminuser.nome');?></th> 
                                <th><?php echo __('jqueryadminuser.mail');?></th> 
                                <th><?php echo __('jqueryadminuser.senha');?></th> 
                            ...
                            <tr>
                                ...
                                <td><?php echo $registro->getSenha(); ?></td>
