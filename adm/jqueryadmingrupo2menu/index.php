...
$where = '';
if ($filtraList) {
    //$where = new dataFilter(dbJqueryadmingrupo2menu::_cod, 0, dataFilter::op_different);
    $where = new dataFilter(dbJqueryadmingrupo2menu::_cod, $filtraList, dataFilter::op_likeMatches);
}

$orderBy = new dataOrder('jqueryadmingrupo2menu.cod', 'desc');

$paginaAtual = 0;
if (isset($_REQUEST['page']))
    $paginaAtual = $_REQUEST['page'];

$pager = new dataPager($paginaAtual, 15, $Conexao, 'jqueryadmingrupo2menu', $where);

$dados = dbJqueryadmingrupo2menu::ObjsListLeft($Conexao, $where, $orderBy, $pager->getLimit());
...
<html>
    <head>
        <title><?php echo __('table_jqueryadmingrupo2menu'); ?> - Listar</title>
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_jqueryadmingrupo2menu'); ?> <small>Listar</small></h3>
                </div>
                    ...
                    <table class="table table-hover table-striped" id="tablelista">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('jqueryadmingrupo2menu.cod');?></th> 
                                <th><?php echo __('jqueryadmingrupo2menu.jqueryadmingrupo');?></th> 
                                <th><?php echo __('jqueryadmingrupo2menu.jqueryadminmenu');?></th> 
                            ...
                            <tr>
                                ...
                                <td><?php echo $registro->objJqueryadmingrupo()->getTitulo(); ?></td>
                                <td><?php echo $registro->objJqueryadminmenu()->getTitulo(); ?></td>
