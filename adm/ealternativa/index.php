...
$where = '';
if ($filtraList) {
    //$where = new dataFilter(dbEalternativa::_cod, 0, dataFilter::op_different);
    $where = new dataFilter(dbEalternativa::_descricao, $filtraList, dataFilter::op_likeMatches);
}

$orderBy = new dataOrder('ealternativa.cod', 'desc');

$paginaAtual = 0;
if (isset($_REQUEST['page']))
    $paginaAtual = $_REQUEST['page'];

$pager = new dataPager($paginaAtual, 15, $Conexao, 'ealternativa', $where);

$dados = dbEalternativa::ObjsListLeft($Conexao, $where, $orderBy, $pager->getLimit());
...
<html>
    <head>
        <title><?php echo __('table_ealternativa'); ?> - Listar</title>
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_ealternativa'); ?> <small>Listar</small></h3>
                </div>
                    ...
                    <table class="table table-hover table-striped" id="tablelista">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('ealternativa.cod');?></th> 
                                <th><?php echo __('ealternativa.quiz');?></th> 
                                <th><?php echo __('ealternativa.pergunta');?></th> 
                                <th><?php echo __('ealternativa.descricao');?></th> 
                                <th><?php echo __('ealternativa.imagem');?></th> 
                                <th><?php echo __('ealternativa.ordem');?></th> 
